...
Las tres rutas muestran estado vacío cuando no hay filas, como ocurre actualmente tras la migración structure-only. No hay formularios, Server Actions mutantes, edición, eliminación, filtros por nivel/subred ni exposición de `capabilities`, serializados, secretos, licencias o filas legacy.
