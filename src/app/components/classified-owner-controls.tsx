...
export function ClassifiedOwnerControls({
  classifiedId,
  title,
  body,
  categoryId,
  ...
  return (
    <section className="owner-manage-panel" aria-labelledby="classified-manage-title">
      <h2 id="classified-manage-title">Gestionar clasificado</h2>
