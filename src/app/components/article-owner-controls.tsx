...
export function ArticleOwnerControls({
  articleId,
  title,
  body,
  categoryId,
  ...
  const [visibleState, visibleAction] = useActionState<ArticleManageFormState, FormData>(
    setArticleVisibleAction,
    {},
  );

  return (
    <section className="owner-manage-panel" aria-labelledby="article-manage-title">
      <h2 id="article-manage-title">Gestionar artículo</h2>
